...
import { FundingState, DirectFundingStatus } from './funding-state/state';
...
export const getIndirectFundingState = (state: walletStates.Initialized): IndirectFundingState => {
