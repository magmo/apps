...
import { faCheckCircle, faSpinner, faHourglassEnd, faHourglassHalf, faHourglassStart, faBullhorn } from '@fortawesome/free-solid-svg-icons';
...
const timeOutIcon = (
  <span className="fa-li" ><FontAwesomeIcon icon={faHourglassEnd} size="lg" color="green" /></span>
);
...
export class ChallengingStep extends React.PureComponent<Props> {
  render() {
    ...
    const CHALLENGE_PERIOD_MESSAGE = "If they don't respond by " + expiryDate + ", the channel will be closed and you can withdraw your funds.";
    return (
      <SidebarLayout>
