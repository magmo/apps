...
const MAGMO_VALUES = ['ADJUDICATOR_ABI', 'CONSENSUS_LIBRARY_ADDRESS', 'ADJUDICATOR_ADDRESS', 'TARGET_NETWORK', 'TARGET_NETWORK_ID', 'FIREBASE_PROJECT', 'FIREBASE_API_KEY', 'DEV_GANACHE_PORT'];
